...
export const metadata: Metadata = {
  title: "Coffee Haven - Premium Specialty Coffee Shop",
  description: "Discover authentic specialty coffee roasted to perfection. Visit our cozy coffee shop for expertly crafted drinks and a welcoming community.",
  keywords: "specialty coffee, coffee shop, artisan roasted, barista, latte, cappuccino",
  openGraph: {
    title: "Coffee Haven - Premium Specialty Coffee",
    description: "Experience exceptional coffee crafted with passion",
